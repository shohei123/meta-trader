...
//+------------------------------------------------------------------+
/* Note that the presence of any font in the system depends
   on the options set during the operation system installation, as well as
   on the software. There are several 
   fonts that are present in any Windows version.
   These fonts are the safest for web design and creation
   of electronic documents that must be displayed equally 
   on different computers.
   Safe fonts: Arial, Courier, Courier New, MS Sans Serif, 
                        MS Serif, Symbol, Times New Roman.
   There are fonts that are not included in earlier Windows 
   versions but are almost always present in the system 
   (being installed together with additional software, 
   for example, Microsoft Office): Arial, Courier, Courier New, 
   MS Sans Serif, MS Serif, Symbol, Times New Roman.
   Almost safe fonts: Comic Sans MS, Tahoma, Trebuchet MS, Verdana. 
   */
